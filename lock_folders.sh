...
if [ "$1" != "" ]; then
        echo "[Bloqueando directorios y ficheros de $1]"
        ...
        chown -R root:google-sudoers "/var/www/$1/httpdocs/wp-content/plugins/"
	...
	chmod -R 0755 "/var/www/$1/httpdocs/wp-content/plugins/"
	chmod -R 0755 "/var/www/$1/httpdocs/wp-content/themes/"
        echo "[Hecho]"
else
        echo "Falta el nombre del directorio a bloquear: ./lock_folders.sh directorio"
fi
